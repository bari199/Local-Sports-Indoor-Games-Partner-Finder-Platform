    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="flex-1">
        <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mb-6 overflow-hidden rounded-xl border border-slate-200 bg-white p-1">
              ...
              <div>
                ...
                {partners.length > 0 ? (
                  ...
                  <EmptyState
                    ...
                    description="
                      Accept a partner request to start building your connections.
                    "
                  />
                )}
      ...
      {/* ======================================================
          FOOTER
          IMPORTANT: OUTSIDE MAIN CONTENT
      ====================================================== */}
